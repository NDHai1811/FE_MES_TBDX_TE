...
import { Row, Col, Button, Table, Modal, Input, Form, InputNumber, message, Space, Select } from 'antd';
                ...
                <Row className='mt-3 ml-10' gutter={[24, 0]}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Tên sản phẩm" name="product_id">
                            <Select options={options} placeholder="Chọn tên sản phẩm" showSearch optionFilterProp="label"/>
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="Số thùng" name="number_bin">
                            <InputNumber placeholder='Nhập số lượng thùng' className='w-100'/>
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="Số lượng" name="so_luong">
                            <InputNumber placeholder='Nhập số lượng trên thùng' className='w-100' />
                        </Form.Item>
                    </Col>
                    <Col span={24}>
                        <Button type='primary' htmlType='submit' className='w-100'>In Tem</Button>
                    </Col>
                </Row>
            </Form>
