...
const Warehouse = (props) => {
      ...
      return <>
            <Sider style={{ backgroundColor: 'white', maxHeight: '90vh', float: 'left', overflow: 'auto' }}>
                  ...
                  <div className='mb-3'>
                        <Form style={{ margin: '0 15px' }} layout="vertical">
                              <Form.Item className='mb-3'>
                                    <Select
                                          defaultValue="0"
                                          options={[{ value: '0', label: 'Kế hoạch xuất kho' }, { value: '1', label: 'Thống kê báo cáo' }]}
                  ...
                  <div className='mb-3'>
                        <Form style={{ margin: '0 15px' }} layout="vertical">
                              <Form.Item label="Kho" className='mb-3'>
                                    <Select
                                          defaultValue="kho1"
                                          options={[{ value: 'kho1', label: 'Kho 1' }, { value: 'kho2', label: 'Kho 2' }]}
                                    />
                              </Form.Item>
                              <Form.Item label="Giá" className='mb-3'>
                                    <Select
                                          defaultValue="gia1"
                                          options={[{ value: '1', label: 'Giá 1' }, { value: '2', label: 'Giá 2' }]}
                                    />
                              </Form.Item>
                              <Form.Item label="Rack" className='mb-3'>
                                    <Select
                                          defaultValue="1"
                                          options={[{ value: '1', label: 'Rack 1' }, { value: '2', label: 'Rack 2' }]}
                                    />
                              </Form.Item>
                        </Form>
                  </div>
                  ...
                  <div className='mb-3' style={{ padding: '10px', textAlign: 'center' }} layout="vertical">
                        <Button type='primary' style={{ width: '80%' }}>Truy vấn</Button>
                  </div>
            </Sider>
            <Row style={{ height: '90vh' }}>
                  <Col span={24} style={{ padding: "10px", }}>
                        <Card style={{ height: '100%' }} title={isSelectAction == false ? "Kế hoạch xuất kho" : "Thống kê báo cáo"}>
                              {
                                    isSelectAction == false ?
                                          <>
                                                <Row style={{ float: 'right' }} className='mb-3'>
                                                      <Button style={{ marginLeft: '15px' }} type="primary" icon={<UploadOutlined />}>
                                                            Up Excel
                                                      </Button>
                                                      <Button style={{ marginLeft: '15px' }} icon={<PlusOutlined />} type='primary'>Thêm hàng</Button>
                                                </Row>
                                          </>
                                          :
                                          <>
                                                <Row style={{ float: 'right' }} className='mb-3'>
                                                      <Button style={{ marginLeft: '15px' }} type="primary" icon={<FileExcelOutlined />}>
                                                            Xuất Excel
                                                      </Button>
                                                      <Button style={{ marginLeft: '15px' }} icon={<PrinterOutlined />} type='primary'>
                                                            In file
                                                      </Button>
                                                </Row>
                                          </>
                              ...
                              <Table
                                    ...
                                    dataSource={isSelectAction == false ? data_planExport : data_report}
                              />
                        </Card>
                  </Col>
            </Row>
