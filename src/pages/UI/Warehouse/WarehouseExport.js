import {
  ...
  import { createWareHouseFGExport, exportWarehouseExportNote, getWarehouseFGExportList, updateWarehouseFGExport, warehouseExportLogList } from "../../../api/ui/warehouse";
  ...
  const WarehouseExport = () => {
    ...
    const exportFile = async () => {
      ...
      const res = await exportWarehouseExportNote(listCheck);
      if (res.success) {
