...
const CreateMaintenance = () => {
        ...
        return (
          <Space wrap style={{ justifyContent: "center" }}>
            <Button
              size="small"
              icon={<EditOutlined />}
              onClick={() => updateCategory({ ...record, index })}
            >
              Sửa
            </Button>
            <Button
              ...
              icon={<DeleteOutlined />}
              danger
              onClick={() => deleteCategory({ ...record, index })}
            >
              Xoá
            </Button>
          </Space>
  ...
  const deleteCategory = (record) => {
    ...
    setMaintenanceDetailList((prev) =>
      prev.filter((e, index) => index !== record.index)
    );
  };
    ...
    <>
      <Row style={{ padding: "8px" }} gutter={[8, 8]}>
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col span={12}>
                ...
                >
                  <Select
                    options={machines}
                    placeholder="Chọn thiết bị bảo dưỡng"
                  ></Select>
                </Form.Item>
              </Col>
              <Col span={24}>
        ...
        >
          ...
          >
            <Form.Item name="index" style={{ display: "none" }}></Form.Item>
            <Form.Item name="id" style={{ display: "none" }}></Form.Item>
            <Row gutter={[8, 8]}>
              <Col span={12}>
                <Form.Item
