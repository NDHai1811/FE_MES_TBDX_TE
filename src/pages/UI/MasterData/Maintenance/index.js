...
import { createMaintenance, deleteMaintenance, exportMaintenance, getListMachine, getMaintenance, updateMaintenance } from '../../../../api';
...
const Maintenance = () => {
    ...
    return <>
        ...
        <Row style={{ padding: '8px', height: '90vh' }} gutter={[8, 8]}>
                ...
                <Col span={21}>
                    <Card style={{ height: '100%' }} title="Bảo trì bảo dưỡng" extra={
                        <Space>
                            {/* <Upload
