...
import { createPermissions, deletePermissions, exportPermissions, getPermissions, updatePermissions } from '../../../api';
...
const Permissions = () => {
    ...
    return <>
        ...
        <Row style={{ padding: '8px', height: '90vh' }} gutter={[8, 8]}>
                ...
                <Col span={21}>
                    <Card style={{ height: '100%' }} title="Quản lý quyền" extra={
                        <Space>
                            <Upload
        ...
        <Modal title={isEdit ? 'Cập nhật' : 'Thêm mới'} open={openMdl} onCancel={() => setOpenMdl(false)} footer={null}>
