...
const options = [
      {value: '0', label: 'Quản lý Line', titleCard:'Danh sách Line', colTable:colLine, dataTable:dataLine }, 
      {value:'1', label:'Quản lý BOM', titleCard:'Danh sách BOM' , colTable:colBom, dataTable:dataBom },
      {value:'2', label:'QL Lịch làm việc', titleCard:'Lịch làm việc', colTable:colSchedule, dataTable:dataSchedule}]
...
const Category = (props) => {
      ...
      return <>
            <Sider style={{backgroundColor:'white', maxHeight:'100vh', float:'left', overflow:'auto'}}>
