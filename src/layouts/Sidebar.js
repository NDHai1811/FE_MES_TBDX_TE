import { Layout, Divider, Button, Table, Menu, Card, Checkbox, DatePicker, Form, Input, theme, Col, Select, AutoComplete } from 'antd';
...
const SidebarUI = () => {
  ...
  return (
    <React.Fragment>
        <Sider style={{backgroundColor:'white', minHeight:'100vh', float:'left', paddingTop:'15px'}} collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
            <div className='mb-3'>
