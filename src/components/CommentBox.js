      ...
      return (
            <div style={{ top: top, left: left, backgroundColor: color, ...above }}>
                  ...
                  <div style={st_message}>
                        ...
                        <div style={{ width: '100%', textAlign: 'center', height: '3.8vw', background: '#fff', borderRadius: '0 0 3.1vw 3.1vw',fontSize:'14px',lineHeight:'1.2vw' }}>
                             {content}
                        </div>
                        <div style={{width:'20px',borderLeft: '10px solid transparent',borderRight: '10px solid transparent',borderTop:'40px solid '+color,margin:'auto'}}></div>
                  </div>
            </div>
      )
}
